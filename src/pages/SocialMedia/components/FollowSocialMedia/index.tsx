  ...
  return (
    <Section>
      ...
      <Stack spacing={3} sx={{ alignItems: "center", mx: "auto" }}>
        <SocialCard
          icon={
            <InstagramIcon sx={{ fontSize: 80, color: Colors["Orange_50"] }} />
          }
          title="Instagram"
        ...
        <SocialCard
          icon={
            <FacebookIcon sx={{ fontSize: 80, color: Colors["Green_70"] }} />
          }
          title="Facebook"
        ...
        <SocialCard
          icon={
            <LinkedInIcon sx={{ fontSize: 80, color: Colors["Blue_60"] }} />
          }
          title="LinkedIn"
        ...
        <SocialCard
          icon={<YouTubeIcon sx={{ fontSize: 80, color: Colors["Pink_50"] }} />}
          title="YouTube"
