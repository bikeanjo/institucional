  ...
  const articulations = [
    {
      ...
      url: "/assets/icons/logo-bike-anjo-verdanjo.svg",
    ...
    },
    {
      ...
      url: "/assets/icons/logo-bike-anjo-roxanjo.svg",
    ...
    },
    {
      ...
      state: "Rio de Janeiro",
      region: "Sudeste",
      instagram: "@bikeanjozonasulrj",
      facebook: "bikeanjozonasulrj",
      location:
        "Parque das Figueiras - Av. Borges de Medeiros, 1426 - Lagoa, Rio de Janeiro - RJ, 22470-003",
      date: "Todo 2º domingo do mês",
      time: "Das 14:00 às 17:00",
      registration:
        "Online no formulário divulgado na semana anterior do evento no perfil @bikeanjozonasulrj",
      url: "/assets/icons/logo-bike-anjo-roxanjo.svg",
      coords: tupleCoords(-22.9815, -43.215),
    },
    {
      id: "flamengo-rj",
      name: "Flamengo",
      ...
      facebook: "bikeanjozonasulrj",
      location:
        "MAM (Museu de Arte Moderna) - Av. Infante Dom Henrique, 85 - Parque do Flamengo, Rio de Janeiro - RJ, 20021-140",
      date: "Todo 4º domingo do mês",
      time: "Das 14:00 às 17:00",
      registration:
        "Online no formulário divulgado na semana anterior do evento no perfil @bikeanjozonasulrj",
      url: "/assets/icons/logo-bike-anjo-verdanjo.svg",
      coords: tupleCoords(-22.913375, -43.17198),
    },
  ];
