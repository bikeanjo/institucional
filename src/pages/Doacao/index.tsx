  ...
  return (
    <>
      ...
      >
        ...
        <Text center>
          Qualquer valor já ajuda a manter a Bike Anjo na rua, na rede e na vida
          de muita gente.
        </Text>
      </Box>
      ...
      >
        ...
        <Text center>
          Quando você divulga a Bike Anjo, ajuda a levar nossa missão ainda mais
          longe. Sua rede pode ser o elo que conecta uma pessoa à sua primeira
          pedalada. E isso vale muito!
        </Text>
        <Box
          sx={{
            display: "flex",
