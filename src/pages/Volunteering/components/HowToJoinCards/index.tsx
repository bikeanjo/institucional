...
function HowToJoinCards(): ReactNode {
  const cards: {
    ...
    {
      id: "card1",
      imgUrl: "/assets/images/HowToJoinCards/pink-icon-bike-anjo.webp",
      cardColor: "#E1216D",
    ...
    {
      id: "card2",
      imgUrl: "/assets/images/HowToJoinCards/blue-icon-bike-anjo.webp",
      cardColor: "#1C97C5",
    ...
    {
      id: "card3",
      imgUrl: "/assets/images/HowToJoinCards/orange-icon-bike-anjo.webp",
      cardColor: "#ED601C",
    ...
    {
      id: "card4",
      imgUrl: "/assets/images/HowToJoinCards/green-icon-bike-anjo.webp",
      cardColor: "#4D7A18",
